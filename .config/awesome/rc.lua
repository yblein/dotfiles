...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(wallpaper, s, "#303030")
    end
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({  "1:www", "2:dev", "3:com", "4:doc", "5:sys" }, s, awful.layout.layouts[2])
...
tags_keys = {"a", "s", "d", "f", "g"}
for i = 1, #tags_keys do
    globalkeys = awful.util.table.join(globalkeys,
        -- View tag only.
        awful.key({ modkey }, tags_keys[i],
                  function ()
        ...
        -- Toggle tag display.
        awful.key({ modkey, "Control" }, tags_keys[i],
                  function ()
                      local screen = awful.screen.focused()
                      local tag = screen.tags[i]
                      if tag then
        ...
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, tags_keys[i],
                  function ()
                      if client.focus then
        ...
        awful.key({ modkey, "Control", "Shift" }, tags_keys[i],
                  function ()
                      if client.focus then
                          local tag = client.focus.screen.tags[i]
                          if tag then
