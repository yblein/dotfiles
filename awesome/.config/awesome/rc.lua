...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "1:www", "2:dev", "3:com", "4:doc", "5:sys" }, s, layouts[2])
end
-- }}}
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"   }, "Right", function () awful.layout.inc(layouts,  1) end),
    awful.key({ modkey, "Shift"   }, "Left",  function () awful.layout.inc(layouts, -1) end),
